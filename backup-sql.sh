...
docker exec -it $CONTAINER_NAME /opt/mssql-tools18/bin/sqlcmd -S -C localhost -U sa -P $(<../documents/overflow/password.txt)  -Q "BACKUP DATABASE OverflowDB TO DISK = N'$BACKUP_PATH'"
